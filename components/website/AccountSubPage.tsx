                    ...
                    <ul className="nav nav-pills">
                        <li className="nav-item">
                            <Link href="/ieieiee/eueuueue">
                                <a className="nav-link active" data-bs-toggle="pill" aria-selected="true">
                        ...
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" aria-selected="false">
                                <button className="w-full h-full">
                                    <div className="provide-nav">
                        ...
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-contact-tab" data-bs-toggle="pill" aria-selected="false">
                                <button className="w-full h-full">
                                    <div className="provide-nav">
                        ...
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-loans-tab" data-bs-toggle="pill" aria-selected="false">
                                <button className="w-full h-full">
                                    <div className="provide-nav">
                        ...
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-house-tab" data-bs-toggle="pill" aria-selected="false">
                                <button className="w-full h-full">
                                    <div className="provide-nav">
                        ...
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-invest-tab" data-bs-toggle="pill" aria-selected="false">
                                <button className="w-full h-full">
                                    <div className="provide-nav">
